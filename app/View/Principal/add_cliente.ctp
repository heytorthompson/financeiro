...
<div class="form-group">
  ...
  <div class="controls col-lg-8">
    <input id="registro" name="registro" maxlength="20" type="text"  class="form-control" required="">
...
<div class="form-group">
  ...
  <div class="col-lg-2">
    <input id="ddd" name="ddd" type="text" maxlength="2"  placeholder="DD" class="form-control" required="">
  </div>
  <div class="col-lg-5">
...
<div class="col-lg-4">
  <input id="bairo" name="bairro" type="text" placeholder="Bairro"  class="form-control" required="">
</div>
<div class="col-lg-4">
  <input id="cidade" name="cidade" type="text" placeholder="Cidade"  class="form-control" required="">
</div>
<div class="col-lg-3">
